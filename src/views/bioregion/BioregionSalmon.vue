  ...
  <div class="aside-content">
    ...
    <div class="video">
      <iframe
        width="350"
        height="197"
        src="https://www.youtube.com/embed/hERlmXgqv7o?&amp;start=87&amp;autoplay=1&amp;mute=0&amp;loop=1&amp;playlist=hERlmXgqv7o"
        frameborder="0"
    ...
    <div class="caption">
      A voyage from land to sea and back again<br />&mdash;video by Diarmuid,
      <a href="https://www.youtube.com/channel/UCLAqBw-p3I6918YOVCIcIVQ">here</a
      >&mdash;
    </div>
    <br />
    ...
    <p>
      ...
      whether you can do so with them.
    </p>

    <p>
      The data prepared by the National Oceanic and Atmospheric Administration
      are far more complex than any graphic technique could reveal. They divide
      the four endangered species not only into distinct seasonal runs (spring,
      summer or fall) but also into distinct gene pools, associated with the
      real pools and gravel beds that call the fish back to spawn. These
      divisions separate the different populations in time; but in space they
      often overlay one another on the same stream, in a way that is not
      particularly susceptible to representation on a map.
    </p>
    ...
    <p>
      ...
      here, under new scientific guises. Further NOAA documents locate the areas
      where populations have gone extinct, or where stream reaches have been
      entirely blocked by dams. More speculative studies try to assess the
      geographical range in which the fish <em>could</em> potentially flourish.
      This kind of science is beautiful, because it opens windows onto non-human
      worlds.
    </p>

    <p>
      A great challenge for cartography would be to render all this knowledge
      perceptible in the blink of an eye. But it's not obvious how, and besides,
      you can get lost in the data. The idea here is to focus on the most
      powerful message that the salmon have for us now, which is that of finding
      a pathway to the place where the cycles originate. What does that message
      mean for contemporary human beings?
    </p>

    <p>
      Five maps can be accessed from the buttons below. Roll the cursor over the
      landscape to find the streams through which each species moves. Locate the
      places that make you want to come closer. Think about river beds,
      currents, cascades, dreamy aquascapes and looming threats of all kinds,
      not just from bears and eagles, but mostly from human construction,
      clearcutting, agricultural runoff, debris and hot water.
    </p>

    <p>
      Can we still feel the link between the oceans and the mountains? Can we
