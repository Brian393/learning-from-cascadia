...
<template>
  <div class="aside-content">
    ...
    <p>
      The natural area was used by the Yakama, Nez Perce and Umatilla tribes,
      and especially by the Wanapum people who lived there year-round. The
    ...
    <p>
      During World War II the US government would create three uranium-fueled
      fission reactors and two chemical conversion plants on this 586
      square-mile site, in order to make plutonium for the first atomic test at
      Trinity and for the bomb that destroyed Nagasaki. Over the following two
      decades they would add six more reactors and a large quantity of
      supporting infrastructure, not to produce electricity, but to guarantee
      "mutual assured destruction" during the Cold War.
    </p>

    <p>
      The site was initially managed by the Du Pont corporation, which set up
      model neighborhoods for officers, engineers, operators and staff in the
      nearby city of Richland. The construction of the main facilities required
    ...
    <p>
      ...
      knowledge of their consequences. Production was pushed to high speeds.
      Wastes were scattered everywhere. The tension redoubled when the Soviets
      exploded their first nuclear device. On December 2-3, 1949, the top brass
      ordered Hanford workers to skip the normal eighty-day period during which
      the irradiated fuel slugs remained underwater, waiting for the short-lived
      isotopes to lose most of their deadly charge. Instead the material would
      be run through the processing plants after only eight days. This
      accelerated
      <a
        href="http://www.hanfordproject.com/greenrun.html"
        target="_blank"
        rel="nofollow"
      >
        Green Run</a
    ...
    <p>
      ...
      disasters. Yet the inexcusable release of iodine-131 during the Green Run
      was dwarfed by the cumulative daily release of multiple radioactive
      materials over the active lifetime of the site. Uranium and plutonium,
      along with a long list of transuranic fission products and a whole catalog
      of dangerous chemicals, were leaked as flakes, particles, liquids or
      aerosols into the land, the air, the inhabitants' bodies and the waters of
      the Columbia River.
    </p>
    ...
    <p>
      ...
      collapsing railroad tunnels, burial grounds and plumes of contaminants
      seeping through the groundwater.
    </p>
    ...
    <p>
      The suburban town of Richland, aptly dubbed "Plutopia" by investigative
      journalist Kate Brown, is still a model of Cold War prosperity. Visit it
      to see the good life. Meanwhile the vast site out in the desert remains a
      shrouded monument to the geological powers wielded by humanity in the
      Anthropocene.
    </p>
    <br />
    <Accordion>
