...
<template>
  <div class="aside-content">
    ...
    <p>
      ...
      construction and compensation were haggled out, along with contracts for
      the sale of surplus Canadian hydroelectricity. The Columbia River Treaty
      was signed and the Mica, Duncan, Libby and Keenleyside dams were erected,
      creating an upriver storage system that canceled the chaotic surge of
      spring snowmelt.
    </p>
    ...
    <div class="caption">
      ...
      <a
        href="https://www.energy.gov/oe/articles/bpa-grid-modernization-and-setting-nation-success"
        target="_blank"
        rel="nofollow"
        >here</a
      >)
    ...
    <p>
      At present the Pacific Northwest Coordination Agreement regulates the
      annual flow of the entire transborder system, in a highly computerized
      attempt at harmonizing the fluctuating demands of power production, flood
      control, navigation, recreation and the survival of endangered fish
      species. Within a single river reach -- such as the Lower, Middle or Upper
      Columbia -- as many as ten dams will synchronize their water releases on
      an hourly basis, producing a managed diurnal pulse that has become second
      nature. Not the vagaries of the snowpack or the afternoon weather, but a
      logic of efficiency and optimization shapes the flow of the Columbia
      River.
    </p>

    <p>
      The construction of the water-management system signified the entry into a
      new era, not yet called the Anthropocene. By the close of the 1970s, when
      the frenzy of dam-building passed its peak and the Cold War weapons boom
      began subsiding, all human and non-human inhabitants of the basin were
      faced with the new reality of the river, which the environmental historian
      Richard White characterized as an "organic machine." Within this
      framework, White explained, labor has not "conquered" nature. Instead the
      transformative labor of technological production "involves human beings
      with the world so thoroughly that they can never be disentangled."
    </p>
    ...
    <p>
      Still there was at least one problem with this new union of humanity and
      nature. The vast system of dams was slowly wiping out the emblematic
      species of the Pacific Northwest, the salmon, whose numbers began
      precipitously declining even as Native American bands, tribes and nations
      began an historic effort to recover their ancestral rights by catching
      fish "in all the usual and accustomed places." As public support for
    ...
    <p>
      In 1999, Ecotrust in Portland came out with the notion of
      <a
        href="https://ecotrust.org/publication/salmon-nation"
        target="_blank"
        rel="nofollow"
        >Salmon Nation</a
    ...
    <p>
      Today, the preservation of Pacific salmon, the expansion of Native
      American treaty rights, the resistance to fossil-fuel infrastructure and
      the recovery of riverine and forest ecosystems have become strong
      political demands, with clearly identified constituencies and forms of
      political representation stretching across Cascadia. The result is a
      palpable difficulty in maintaining the old system. As the Columbia River
      Treaty is renegotiated, it's clear that the hydrostate isn't working
      anymore.
    </p>

    <p>
      With the ongoing decline in the price of electricity&mdash;due
      particularly to the rise of solar in California&mdash;other facts about
      the dams have become apparent. Among them are the huge scars left on the
      landscape by constantly fluctuating water levels, even after the violence
      of forced population removal has faded. "These are industrial reservoirs.
      They are not lakes,” says Deb Kozak, the mayor of the city of Nelson in
      British Columbia. "These were advertised as lakes with great recreational
      opportunities when the dams were created. They are not."
    </p>

    <p>
      D.R. Michel, executive director of the Upper Columbia United Tribes, is
      even more forceful about the consequences of damming the river system:
      "It’s not just a machine to spin turbines and protect Portland. They
      permanently took the floods that happened annually down river and moved
      them up into our area, so we feel those impacts and those losses every
      day."
    </p>

    <p>
      Within the organic machine of the Columbia River, entanglement is the
      common condition. Salmon have emerged as totemic guides to a new kind of
      nation. Yet like the fish, we have to deal with what already exists. The
      real labor today is not returning to a wild state, but instead, finding a
      viable pulse for the Anthropocene metabolism.
    </p>
