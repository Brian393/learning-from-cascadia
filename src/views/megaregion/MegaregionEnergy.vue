<template>
  <div class="aside-content">
    ...
    <p>
      Follow the crimson lines of the power grid to each site. Roll over the
      icon with the mouse and an image appears. Click for some more information.
      Zoom in to see the lay of the land.
    </p>

    <p>
      If there's such a thing as an urban metabolism, then it can't stop at the
      limits of the city&mdash;or even the megaregion. Industrial corridors
      reach out into the hinterland, where the material energies of the
      territory are captured, channelled and transformed for use in the
    ...
    <p>
      ...
      the grid. You can follow the transmission lines back to Portland, Seattle,
      Spokane, Kalispell or wherever. If you recognize the landmarks of your
      neighborhood, you might even be able to see the substation you're drawing
      power from right now.
    </p>
    ...
    <p>
      The idea is to at once imagine and retrace the energy-relations linking
      habits, our homes, our means of transportation, our workplaces and
      institutions&mdash;in short, our lives in society&mdash;to the vast
      productive territories that lie out of sight, far beyond the city.
    </p>
  </div>
</template>
<style scoped>
